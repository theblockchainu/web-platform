...
@Component({
	...
	templateUrl: './request-knowledge-story.component.html',
	styleUrls: ['./request-knowledge-story.component.scss']
})
export class RequestKnowledgeStoryComponent implements OnInit {
	...
	constructor(myElement: ElementRef,
		...
		public dialogRef: MatDialogRef<RequestKnowledgeStoryComponent>,
