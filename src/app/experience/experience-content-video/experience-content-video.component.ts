...
@Component({
    ...
    templateUrl: './experience-content-video.component.html',
    styleUrls: ['./experience-content-video.component.scss']
})

export class ExperienceContentVideoComponent implements OnInit {
