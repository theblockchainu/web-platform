...
@Component({
    ...
    styleUrls: ['./experience-content-quiz.component.scss']
})
export class ExperienceContentQuizComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<ExperienceContentQuizComponent>,
