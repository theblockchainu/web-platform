...
@Component({
	selector: 'app-bounty-content-project',
	templateUrl: './bounty-content-project.component.html',
	styleUrls: ['./bounty-content-project.component.scss']
})

export class BountyContentProjectComponent implements OnInit {
	...
	constructor(
		...
		public dialogRef: MatDialogRef<BountyContentProjectComponent>,
