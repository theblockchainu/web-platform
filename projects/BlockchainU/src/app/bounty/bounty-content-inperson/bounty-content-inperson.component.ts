...
@Component({
    selector: 'app-bounty-content-inperson',
    templateUrl: './bounty-content-inperson.component.html',
    styleUrls: ['./bounty-content-inperson.component.scss']
})
export class BountyContentInpersonComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<BountyContentInpersonComponent>,
