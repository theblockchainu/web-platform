...
export class BountyEditComponent implements OnInit, AfterViewInit, OnDestroy {
	...
	public getContents(contents) {
		...
		if (this.sidebarMenuItems) {
			...
			// this.sidebarMenuItems = this._leftSideBarService.updateSideMenu(this.bounty.value, this.sidebarMenuItems);
			// this.sidebarMenuItems[2]['submenu'] = [];
		}
	...
	public addImageUrl(value: String) {
		...
		this.sidebarMenuItems = this._leftSideBarService.updateSideMenu(tempBountyData, this.sidebarMenuItems);
	...
	public submitAssessment() {
		...
		this._collectionService.updateAssessmentModel(this.bountyId, {
			...
			this._leftSideBarService.updateSideMenu(this.bountyData, this.sidebarMenuItems);
