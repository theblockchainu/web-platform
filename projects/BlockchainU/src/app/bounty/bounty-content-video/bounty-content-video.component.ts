...
@Component({
    selector: 'app-bounty-content-video',
    templateUrl: './bounty-content-video.component.html',
    styleUrls: ['./bounty-content-video.component.scss']
})

export class BountyContentVideoComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<BountyContentVideoComponent>,
