...
export class GuideContentComponent implements OnInit, AfterViewInit {
	@Input()
	...
	reload(collectionId, step) {
		window.location.href = '/guide/' + collectionId + '/edit/' + step;
	}

	private executeSubmitGuide(collection) {
	...
	showDialogForActiveGuide(isContent) {
