...
@Component({
    selector: 'app-guide-content-video',
    templateUrl: './guide-content-video.component.html',
    styleUrls: ['./guide-content-video.component.scss']
})

export class GuideContentVideoComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<GuideContentVideoComponent>,
