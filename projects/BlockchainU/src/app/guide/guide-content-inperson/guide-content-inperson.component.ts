...
@Component({
    selector: 'app-guide-content-inperson',
    templateUrl: './guide-content-inperson.component.html',
    styleUrls: ['./guide-content-inperson.component.scss']
})
export class GuideContentInpersonComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<GuideContentInpersonComponent>,
