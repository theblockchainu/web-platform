...
@Component({
	selector: 'app-guide-content-project',
	templateUrl: './guide-content-project.component.html',
	styleUrls: ['./guide-content-project.component.scss']
})

export class GuideContentProjectComponent implements OnInit {
	...
	constructor(
		...
		public dialogRef: MatDialogRef<GuideContentProjectComponent>,
